...
\addchap*{Credits}
\setcounter{page}{1}
\input{03_content/credits}

\input{03_content/abstract}
...
\cleardoublepage
\input{03_content/quote}
\input{03_content/chapter_Intro}
\cleardoublepage
\input{03_content/chapter_SotA}
\cleardoublepage
\input{03_content/chapter_Description}
\cleardoublepage
\input{03_content/chapter_Detection}
\cleardoublepage
\input{03_content/chapter_Handling}
\cleardoublepage
\input{03_content/chapter_Extro}
\cleardoublepage
% ...
...
%\input{03_content/appendix1}
%\input{03_content/appendix2_GPU_Voxels}
\cleardoublepage
\backmatter
